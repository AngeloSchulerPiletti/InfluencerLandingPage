...
import { SectionPictureMock } from './mock/sectionPicture.mock'
import { SectionFooterMock } from './mock/sectionFooter.mock'
...
export const Home: Story = {
  args: {
    ...
    picture: SectionPictureMock,
    footer: SectionFooterMock,
  },
}
